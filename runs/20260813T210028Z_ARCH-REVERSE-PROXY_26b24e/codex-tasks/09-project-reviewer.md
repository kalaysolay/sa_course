# Project Artifact Reviewer: ARCH-REVERSE-PROXY

Task: Review proposed project artifacts against the lesson, case continuity, and rubric.
Expected output: `05-project/reviews/project-v1.json`
...
- Section: M05-S03 - Основные инфраструктурные компоненты
- Topic: 28. Reverse proxy и балансировка — обзор (ARCH-REVERSE-PROXY)
- Topic Passport: course/modules/M05-architecture/sections/S03-infrastructure/topics/reverse-proxy.yaml
...
- The final tracker owner is `10-tracker-updater.md`, which updates https://docs.google.com/spreadsheets/d/1She4DAsy9KIQ0uXdMDbTvtDsftT3BNBiorYMScyArew/edit.
