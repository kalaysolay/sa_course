# Project Artifact Reviewer: PROF-ARTIFACTS
...
- Section: M01-S03 - Наш путь на курсе
- Topic: 8. Какие результаты и артефакты возникают по пути (PROF-ARTIFACTS)
- Topic Passport: course/modules/M01-profession/sections/S03-course-path/topics/artifacts-path.yaml
