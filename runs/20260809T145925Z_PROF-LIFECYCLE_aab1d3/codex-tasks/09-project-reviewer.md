# Project Artifact Reviewer: PROF-LIFECYCLE
...
- Section: M01-S02 - Работа аналитика
- Topic: 5. Жизненный цикл работы аналитика в проекте (PROF-LIFECYCLE)
- Topic Passport: course/modules/M01-profession/sections/S02-ba-sa/topics/analyst-lifecycle.yaml
