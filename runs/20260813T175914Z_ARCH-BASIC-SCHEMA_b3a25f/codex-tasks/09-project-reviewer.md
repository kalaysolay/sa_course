# Project Artifact Reviewer: ARCH-BASIC-SCHEMA
...
- Topic: 24. Базовая схема client → frontend → backend → database (ARCH-BASIC-SCHEMA)
- Topic Passport: course/modules/M05-architecture/sections/S01-information-systems/topics/basic-schema.yaml
