# Project Artifact Reviewer: PROF-BA-SA-PATH
...
- Topic: 7. От бизнес-проблемы до системной спецификации (PROF-BA-SA-PATH)
- Topic Passport: course/modules/M01-profession/sections/S03-course-path/topics/ba-sa-path.yaml
