# Project Artifact Reviewer: PROF-ROLE
...
- Module: M01 - О профессии системного аналитика
- Section: M01-S01 - Роль аналитика
- Topic: 1. Роль системного аналитика и его типовые задачи (PROF-ROLE)
- Topic Passport: course/modules/M01-profession/sections/S01-role/topics/analyst-role.yaml
