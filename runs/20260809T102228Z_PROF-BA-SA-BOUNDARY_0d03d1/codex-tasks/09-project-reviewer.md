# Project Artifact Reviewer: PROF-BA-SA-BOUNDARY
...
- Module: M01 - Профессия аналитика в IT
- Section: M01-S01 - Кто такие аналитики
- Topic: 3. Где проходит граница между БА и СА и почему на практике она размыта (PROF-BA-SA-BOUNDARY)
- Topic Passport: course/modules/M01-profession/sections/S01-role/topics/ba-sa-boundary.yaml
