...
- используй абзацы и единый сценарий как основную форму; bullets оставляй только для независимых пунктов, коротких чек-листов и итогов;
...
- таблица не заменяет объяснение;
- для сложной технической абстракции используй уместную аналогию, если она проясняет роль или поток работы, и сразу обозначай границу ее применимости;
